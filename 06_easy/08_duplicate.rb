...
Input:
Array with one duplicated element

Output:
Value of duplicate from Array

Data Structure:
Use array given

Algorithm:
First, sort the array. then iterate. if current element is equal to last element, return it!

=end

def find_dup(array)
  array.sort.each_with_index do |element, index|
    return element if element == array.sort[index - 1]
  end
end
